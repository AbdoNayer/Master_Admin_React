          ...
          <CCard>
            <CCardHeader className='mb-5 p-4 flex flexItemCenter flexSpace'>
              ...
              <div className='flex flexItemCenter'>
                <CButton
                    className={fade ? 'mr-2 ml-2 bg-info text-white' : 'mr-2 ml-2'}
            ...
            <CCardBody>
              <CFormGroup row>
                    ...
                    >
                      {({
                          ...
                          <div className="upload__image-wrapper">
                            <button className='btnUpload' onClick={onImageUpload}{...dragProps}>
                              <FiPlusSquare size={30} className='mt-3 mb-3'/>
                              <span className='d-block w-100'>Organization Logo</span>
                            </button>
                            &nbsp;
                            {imageList.map((image, index) => (
                                <div key={index} className="imageItem">
                                  <img src={image['data_url']} alt="" className='w-100 h-100' />
                                  <div className="btnWrapper">
                                    <CButton className='mr-2 ml-2' onClick={() => onImageUpdate(index)} variant="outline" active color="success" aria-pressed="true">
                                      update
                                    </CButton>
                                    <CButton className='mr-2 ml-2' onClick={() => onImageRemove(index)} variant="outline" active color="danger" aria-pressed="true">
                                      remove
                                    </CButton>
                                  </div>
                                </div>
                ...
                <CCol xs="12" md="8">
                  <CFormGroup row>
                    ...
                    <CCol xs='12' md='6'>
                      <CSelect custom className='mb-3' name="country" id="country" onChange={changeCountry.bind(this)}>
                    ...
                    <CCol xs='12' md='6'>
                      <CSelect custom className='mb-3' name="city" id="city" onChange={changeCity.bind(this)}>
              ...
              <CCardHeader className='mb-5 p-4 flex flexItemCenter flexSpace'>
                ...
                <div className='flex flexItemCenter'>
                  <CButton
                      className={!fade2 ? 'mr-2 ml-2 bg-info text-white' : 'mr-2 ml-2'}
                        ...
                        <CCard className='mt-3 mb-3'>
                          <CCardHeader>
                            ...
                            <div className="card-header-actions">
                              <CFormGroup variant="custom-radio" inline className='p-0 m-0'>
